    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=100, verbose_name="Name of object"),
                ),
                (
                    "type",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date_from",
                    models.DateField(
                        blank=True, null=True, verbose_name="Booking from"
                    ),
                ),
                (
                    "date_to",
                    models.DateField(blank=True, null=True, verbose_name="Booking to"),
                ),
                (
                    "owner",
                    models.ForeignKey(
        ...
        migrations.AddIndex(
            model_name="booking",
            index=models.Index(
                fields=["date_from", "date_to"], name="booking_boo_date_fr_00dee4_idx"
            ),
        ),
    ]
